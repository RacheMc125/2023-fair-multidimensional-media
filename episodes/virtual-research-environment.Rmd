...
organisations to collaborate in a data-driven research process.
...
- What architecture did larger and smaller buildings have?
- How did people dress?
- What activities people did?
...
- **Mailing System and Forum**: enable members to communicate
...
To test some of these in the main interface, find the
menu bar at the top showing the **Workspace** and **Analytics**
...
## Workspace 
The workspace allows a member to create and share folders, 
...
- Preview the file.
- Get basic information - note that very basic metadata, such as name,
...
a special language for formatting text known as [markup](https://jupyter-notebook.readthedocs.io/en/stable/examples/Notebook/Working%20With%20Markdown%20Cells.html).

The environment also supports basic editing of text-data 
...
Navigate to the folder you created by clicking
